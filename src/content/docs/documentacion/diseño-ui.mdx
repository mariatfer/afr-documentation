...
- **Color principal:** Azul oscuro (#04435F) — utilizado en botones, encabezados y elementos importantes.
- **Color secundario:** Verde lima (#a1db0e) — para acentos, botones secundarios y elementos interactivos.
